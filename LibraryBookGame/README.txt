...
Unzip the folder titled ST10238118_Prog7312_Poe_Part2. 
...
the "Replacing Books" game. You can then click on Identifying Areas which will take you to the match the column game. Click the "How To Play" button to learn how to play the game. Click start when you are ready to beat the timer!
